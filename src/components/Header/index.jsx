...
const Header = () => {
    return (
        <header style={{backgroundImage: `url(${Background})`}} className="flex flex-col relative items-center lg:justify-around  sm:justify-center gap-15 bg-cover h-screen">
            <section className='flex flex-col items-center gap-5 lg:max-w-[1100px] sm:max-w-[20rem] mx-auto  '>
            ...
            <section className='w-[90vw] lg:max-w-[1100px] sm:max-w-[20rem] mx-auto'>
